...
package org.thingsboard.server.dao.model.sqlts.timescale.before;
...
import static org.thingsboard.server.dao.sqlts.timescale.AggregationRepository.*;

@Data
@EqualsAndHashCode(callSuper = true)
@Entity
@Table(name = "ts_kv_before")
...
@SqlResultSetMappings({
        @SqlResultSetMapping(
                ...
                classes = {
                        @ConstructorResult(
                                targetClass = TimescaleTsKvBeforeEntity.class,
                                columns = {
...
public final class TimescaleTsKvBeforeEntity extends AbstractTsKvEntity {

    public TimescaleTsKvBeforeEntity() {
    }

    public TimescaleTsKvBeforeEntity(Long tsBucket, Long interval, Long longValue, Double doubleValue, Long longCountValue, Long doubleCountValue, String strValue, String aggType) {
    ...
    public TimescaleTsKvBeforeEntity(Long tsBucket, Long interval, Long booleanValueCount, Long strValueCount, Long longValueCount, Long doubleValueCount, Long jsonValueCount) {
