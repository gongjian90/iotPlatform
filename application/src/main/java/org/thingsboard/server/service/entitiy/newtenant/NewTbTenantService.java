 ...
 * File name:   NewTenantService.java
...
public interface NewTbTenantService {
    Tenant saveTenant(Customer customer) throws Exception;

    void updateTenant(Tenant tenant, Customer customer);
}
